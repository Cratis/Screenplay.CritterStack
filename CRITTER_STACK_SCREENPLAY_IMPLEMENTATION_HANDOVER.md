...
- Verified v0.5.0 and v0.6.0 packages are attached to their GitHub releases and installed in `~/.nuget/cratis-local` with Generation 0.1.0. Scratch consumers restore and execute from that local feed. No workflow or package-manifest changes were made for the local feed.
