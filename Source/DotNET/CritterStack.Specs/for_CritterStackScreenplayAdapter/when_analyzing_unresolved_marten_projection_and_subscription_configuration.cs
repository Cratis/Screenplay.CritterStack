...
public class when_analyzing_unresolved_marten_projection_and_subscription_configuration : given.a_marten_projection_metadata_application
{
    ...
    [Fact] void should_classify_computed_configuration_as_unknown() => Contribution.Diagnostics.Where(_ => _.Message.Contains("could not be resolved", StringComparison.Ordinal) || _.Message.Contains("conditionally", StringComparison.Ordinal)).All(_ => _.Outcome == GenerationDiagnosticOutcome.Unknown).ShouldBeTrue();
