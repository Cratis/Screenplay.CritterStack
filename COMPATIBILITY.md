...
| VogenConcepts | Cratis-owned repository fixture | 9.29.0 | 6.29.2 | Vogen 8.0.7 source generation, concepts and nullable usages, authored validation, explicit normalization/named-instance loss, generated-source exclusion, and identity only from Marten/Wolverine usage |
