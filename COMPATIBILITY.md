...
| VogenConcepts | Cratis-owned repository fixture | 9.29.0 | 6.29.2 | Vogen 8.0.7 source generation, concepts and nullable usages, authored validation, generated-source exclusion, exact Marten alias/upcast and logical tenancy diagnostics, target-aware streams, and the current store-agnostic `[DcbModel]` / `EventTagQuery` API |
