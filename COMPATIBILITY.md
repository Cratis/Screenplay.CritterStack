...
| VogenConcepts | Cratis-owned repository fixture | 9.29.0 | 6.29.2 | Vogen 8.0.7 source generation, concepts and nullable usages, authored validation, generated-source exclusion, exact Marten event alias and typed upcast diagnostics, unchanged event identity, and identity only from Marten/Wolverine usage |
