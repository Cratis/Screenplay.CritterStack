...
- `VOGEN_CONCEPT_DISCOVERY_RESEARCH.md` defines neutral concepts and a separate Vogen interpreter. Screenplay.Generation PR #8 released v0.2.0 with representation/resolution/lowering and exact subject references; PR #9 released v0.3.0 with concept attributes/reasons. Validation remains in #6 before Vogen interpretation #7 and Critter Stack composition #25.
