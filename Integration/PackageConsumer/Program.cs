...
static void AssertDependencyGraph()
{
    ...
    AssertPackage(libraries, "Cratis.Screenplay.Generation.Contracts/0.6.0");
    AssertPackage(libraries, "Cratis.Screenplay.Generation/0.6.0");
    AssertPackage(libraries, "Cratis.Screenplay.Generation.DotNet/0.6.0");
